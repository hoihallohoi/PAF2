...
public class main {
	...
	public static void main(String[] args) {
		...
		Problem adapterObjectProblem = new Problem("TestProb4", "TestSolu4");
		...
		scope.addPattern(adapterObject);
		purpose.addPattern(adapterObject);
		...
		factoryMethod.addProblem(factoryMethodProblem);
		abstractFactory.addProblem(abstractFactoryProblem);
		prototype.addProblem(prototypeProblem);
		singleton.addProblem(singletonProblem);
		adapterObject.addProblem(adapterObjectProblem);
		bridge.addProblem(bridgeProblem);
		composite.addProblem(compositeProblem);
		facade.addProblem(facadeProblem);
		proxy.addProblem(proxyProblem);
		chain.addProblem(chainProblem);
		command.addProblem(commandProblem);
		iterator.addProblem(iteratorProblem);
		mediator.addProblem(mediatorProblem);
		memento.addProblem(mementoProblem);
		observer.addProblem(observerProblem);
		state.addProblem(stateProblem);
		visitor.addProblem(visitorProblem);
		interpreter.addProblem(interpreterProblem);
		template.addProblem(templateProblem);
		
		
		File f = new File("Penguins.jpg");
		Controller.importImage(f, factoryMethod);
		Controller.importImage(f, abstractFactory);
		Controller.importImage(f, builder);
		Controller.importImage(f, prototype);
		Controller.importImage(f, singleton);
		Controller.importImage(f, adapterObject);
		Controller.importImage(f, bridge);
		Controller.importImage(f, composite);
		Controller.importImage(f, decorator);
		Controller.importImage(f, facade);
		Controller.importImage(f, flyweight);
		Controller.importImage(f, proxy);
		Controller.importImage(f, chain);
		Controller.importImage(f, command);
		Controller.importImage(f, iterator);
		Controller.importImage(f, mediator);
		Controller.importImage(f, memento);
		Controller.importImage(f, observer);
		Controller.importImage(f, state);
		Controller.importImage(f, strategy);
		Controller.importImage(f, visitor);
		Controller.importImage(f, interpreter);
		Controller.importImage(f, template);
		Controller.importImage(f, adapterClass);
		//Controller.Start();
		Controller.Update();
